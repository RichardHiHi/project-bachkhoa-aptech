<%-- 
    Document   : shop
    Created on : Aug 21, 2019, 2:30:41 PM
    Author     : Admin
--%>
                        ...
                        <div class="sidebar hidden-after-desk">
                            ...
                            <div class="category-menu-area sidebar-section-margin" id="category-menu-area">
                                <ul>
                                    ...
                                    <li><a href="#"><i class="flaticon-dress"></i>Kid’s Wear<span><i class="flaticon-next"></i></span></a>
                                        <ul class="dropdown-menu">
                                ...
                                <div role="tabpanel" class="tab-pane active clear products-container" id="gried-view">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                        <div class="product-box1">
                                            ...
                                            <div class="product-img-holder">
                                                <a href="#"><img class="img-responsive" src="img/product/9.jpg" alt="product"></a>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                        <div class="product-box1">
                                            ...
                                            <div class="product-img-holder">
                                                ...
                                                <a href="#"><img class="img-responsive" src="img/product/11.jpg" alt="product"></a>
                                            </div>
                                            <div class="product-content-holder">
                                                <h3><a href="#">Product Title Here</a></h3>
                                                <span>$64.00</span>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                        <div class="product-box1">
                                            ...
                                            <div class="product-img-holder">
                                                <a href="#"><img class="img-responsive" src="img/product/12.jpg" alt="product"></a>
                                            </div>
                                            <div class="product-content-holder">
                                                <h3><a href="#">Product Title Here</a></h3>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                        <div class="product-box1">
                                            ...
                                            <div class="product-img-holder">
                                                <a href="#"><img class="img-responsive" src="img/product/7.jpg" alt="product"></a>
                                            </div>
                                            <div class="product-content-holder">
                                                <h3><a href="#">Product Title Here</a></h3>
                                                <span><span>$35.00</span>$25.00</span>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                        <div class="product-box1">
                                            ...
                                            <div class="product-img-holder">
                                                <a href="#"><img class="img-responsive" src="img/product/5.jpg" alt="product"></a>
                                            </div>
                                            <div class="product-content-holder">
                                                <h3><a href="#">Product Title Here</a></h3>
                                                <span><span>$35.00</span>$25.00</span>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                        <div class="product-box1">
                                            ...
                                            <div class="product-img-holder">
                                                <a href="#"><img class="img-responsive" src="img/product/6.jpg" alt="product"></a>
                                            </div>
                                            <div class="product-content-holder">
                                                <h3><a href="#">Product Title Here</a></h3>
                                                <span>$25.00</span>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                        <div class="product-box1">
                                            ...
                                            <div class="product-img-holder">
                                                <a href="#"><img class="img-responsive" src="img/product/8.jpg" alt="product"></a>
                                            </div>
                                            <div class="product-content-holder">
                                                <h3><a href="#">Product Title Here</a></h3>
                                                <span>$25.00</span>
