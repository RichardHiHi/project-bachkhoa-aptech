<%-- 
    Document   : blog
    Created on : Aug 20, 2019, 5:47:45 PM
    Author     : Admin
--%>
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="blog-page-box">
                                    <div class="blog-img-holder">
                                        <a href="#"><img class="img-responsive" alt="blog" src="img/blog/inner1.jpg"></a>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="blog-page-box">
                                    <div class="blog-img-holder">
                                        <a href="#"><img class="img-responsive" alt="blog" src="img/blog/inner2.jpg"></a>
                                    </div>
                                    <div class="blog-content-holder">
                                        <span>January 19, 2016</span>
                                        <h3><a href="#">Blog Title Here</a></h3>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="blog-page-box">
                                    <div class="blog-img-holder">
                                        <a href="#"><img class="img-responsive" alt="blog" src="img/blog/inner3.jpg"></a>
                                    </div>
                                    <div class="blog-content-holder">
                                        <span>January 19, 2016</span>
                                        <h3><a href="#">Blog Title Here</a></h3>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="blog-page-box">
                                    <div class="blog-img-holder">
                                        <a href="#"><img class="img-responsive" alt="blog" src="img/blog/inner4.jpg"></a>
                                    </div>
                                    <div class="blog-content-holder">
                                        <span>January 19, 2016</span>
                                        <h3><a href="#">Blog Title Here</a></h3>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="blog-page-box">
                                    <div class="blog-img-holder">
                                        <a href="#"><img class="img-responsive" alt="blog" src="img/blog/inner5.jpg"></a>
                                    </div>
                                    <div class="blog-content-holder">
                                        <span>January 19, 2016</span>
                                        <h3><a href="#">Blog Title Here</a></h3>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="blog-page-box">
                                    <div class="blog-img-holder">
                                        <a href="#"><img class="img-responsive" alt="blog" src="img/blog/inner6.jpg"></a>
                                    </div>
                                    <div class="blog-content-holder">
                                        <span>January 19, 2016</span>
                                        <h3><a href="#">Blog Title Here</a></h3>
